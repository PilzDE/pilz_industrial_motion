...
KDL::Path* Path_Circle_Helper::circleFromCenter(
...
KDL::Path* Path_Circle_Helper::circleFromInterim(
    const KDL::Frame &start_pose,
    const KDL::Frame &goal_pose,
...
double Path_Circle_Helper::cosines(const double a, const double b, const double c)
{
